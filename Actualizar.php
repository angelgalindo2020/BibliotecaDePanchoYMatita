...
$sqlR="UPDATE usuarios SET Nombre='".$Nombre."', Apellidos='".$Apellido."', DNI='".$DNI."', Domicilio='".$Domicilio."', Poblacion='".$Poblacion."', Provincia='".$Provincia."', FechaNacimiento='".$FechaNac."' Where CodigoUsuario='".$Usuario."'";
