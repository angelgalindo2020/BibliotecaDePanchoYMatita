...
$Precio=($_POST['Precio']);
$sqlR="INSERT INTO libros(NombreLibro, Editorial, Autor, Genero, PaisAutor, NumPaginas, AnioEdicion, Precio) VALUES
       ('".$NombreLibro."', '".$Editorial."', '".$Autor."','".$Genero."', '".$PaisAutor."', '".$NumPaginas."', '".$AnioEdicion."', '".$Precio."')";
