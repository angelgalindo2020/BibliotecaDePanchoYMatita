...
$sqlR="INSERT INTO prestamos(CodigoLibro,CodigoUsuario,FechaSalida,FechaMax,FechaDevolucion) VALUES
       ('".$CodigoLibro."', '".$CodigoUsuario."', '".$FechaSalida."','".$FechaMax."', '".$FechaDevolucion."')";
